        ...
        var g = 'mCustomScrollbar',
            ...
            e = {
                init: function (q) {
                    ...
                    q.axis = q.horizontalScroll
                        ? 'x'
                        : i._findAxis.call(null, q.axis);
                    q.scrollInertia =
                        q.scrollInertia < 17 ? 17 : q.scrollInertia;
                    if (
                        typeof q.mouseWheel !== 'object' &&
                        q.mouseWheel == true
                    ) {
                        q.mouseWheel = {
                            enable: true,
                    ...
                    q.mouseWheel.scrollAmount = !q.mouseWheelPixels
                        ...
                        : q.mouseWheelPixels;
                    q.mouseWheel.normalizeDelta = !q.advanced
                ...
                update: function (q) {
                    ...
                    return j(p).each(function () {
                        ...
                        if (t.data(d)) {
                            ...
                            if (
                                u.axis !== 'y' &&
                                !u.advanced.autoExpandHorizontalScroll
                            ) {
            ...
            i = {
                _selector: function () {
                    return typeof j(this) !== 'object' || j(this).length < 1
                        ? m
                        : this;
                },
                _theme: function (s) {
                    ...
                    if (
                        ...
                        p.css({ position: 'absolute', width: 'auto' })
                            ...
                            .css({
                                width:
                                    Math.ceil(
                                        p[0].getBoundingClientRect().right + 0.4
                                    ) -
                                    Math.floor(
                ...
                _maxHeight: function () {
                    ...
                    if (q !== 'none') {
                        var u = s
                            ? (t.parent().height() * parseInt(q)) / 100
                            : parseInt(q);
                        if (p === 'border-box') {
                            u -=
                                t.innerHeight() -
                ...
                _coordinates: function (q) {
                    ...
                    switch (p) {
                        ...
                        case 'touchend':
                            var r =
                                q.originalEvent.touches[0] ||
                                q.originalEvent.changedTouches[0];
                        ...
                        function (Q) {
                            ...
                            if (K.overflowed[0]) {
                                var O = w[0].parent().height() - w[0].height(),
                                    T =
                                        E - S > 0 &&
                                        S - E > -(O * K.scrollRatio.y);
                            }
                            if (K.overflowed[1]) {
                                var N = w[1].parent().width() - w[1].width(),
                                    V =
                                        G - U > 0 &&
                                        U - G > -(N * K.scrollRatio.x);
                            }
                            if (T || V) {
                                Q.preventDefault();
                            }
                    ...
                    v.bind(
                        ...
                        function (P) {
                            ...
                            var Q = 'mcsEaseOut',
                                R = J < 2.5,
                                W = R
                                    ? [C[C.length - 2], D[D.length - 2]]
                                    : [0, 0];
                            t = R ? [T - W[0], V - W[1]] : [T - L, V - M];
                            var O = [Math.abs(t[0]), Math.abs(t[1])];
                            J = R
                                ? [Math.abs(t[0] / 4), Math.abs(t[1] / 4)]
                                : [J, J];
                            var U = [
                                Math.abs(z[0].offsetTop) -
                                    t[0] * p(O[0] / J[0], J[0]),
                                Math.abs(z[0].offsetLeft) -
                                    t[1] * p(O[1] / J[1], J[1]),
                            ];
                            x =
                                I.axis === 'yx'
                ...
                _mousewheel: function () {
                    ...
                    if (u) {
                        var t = u.opt,
                            ...
                            p = j('#mCSB_' + u.idx),
                            r = [
                                j('#mCSB_' + u.idx + '_dragger_vertical'),
                                j('#mCSB_' + u.idx + '_dragger_horizontal'),
                            ];
                ...
                _draggerRail: function () {
                    var s = j(this),
                        ...
                        p = j(
                            '.mCSB_' +
                                t.idx +
                                '_scrollbar .mCSB_draggerContainer'
                        );
                    p.bind(
                        'touchstart.' +
                            q +
                        ...
                        .bind('click.' + q, function (z) {
                            if (
                                ...
                                if (
                                    w.parent('.mCSB_scrollTools_horizontal')
                                        .length > 0
                                ) {
                                    if (!t.overflowed[1]) {
                                        return;
                        ...
                        r[0]._focusTimeout = setTimeout(function () {
                            var C = [
                                ...
                                z = [
                                    B[0] + C[0] >= 0 &&
                                        B[0] + C[0] <
                                            u.height() - w.outerHeight(false),
                                    B[1] + C[1] >= 0 &&
                                        B[0] + C[1] <
                                            u.width() - w.outerWidth(false),
                                ],
                                A =
                                    s.axis === 'yx' && !z[0] && !z[1]
                                        ? 'none'
                    ...
                    r.attr('tabindex', '0').bind(
                        ...
                        function (D) {
                            ...
                            function y(F, G) {
                                ...
                                x.scrollAmount =
                                    q.snapAmount || q.keyboard.scrollAmount;
                        ...
                        var F = y.type !== 'stepped',
                            ...
                            H =
                                y.dir[0] === 'x'
                                    ...
                                    : I[0] +
                                      y.dir[1] * parseInt(y.scrollAmount),
                        ...
                        u.overwrite,
                        {
                            ...
                            onComplete: function () {
                                if (u.callbacks && u.onComplete) {
                                    ...
                                    B[0].onCompleteTimeout = setTimeout(
                                        function () {
                                            if (t('onScroll')) {
                                                F();
                                            ...
                                            if (
                                                ...
                                                F();
                                                E.callbacks.onTotalScroll.call(
                                                    q[0]
                                                );
                                            }
                                            if (
                                                ...
                                                F();
                                                E.callbacks.onTotalScrollBack.call(
                                                    q[0]
                                                );
                                            }
                    ...
                    function w(M, L, Q, P, N) {
                        switch (N) {
                            ...
                            case 'easeInOutStrong':
                                ...
                                if (M < 1) {
                                    return (
                                        (Q / 2) * Math.pow(2, 10 * (M - 1)) + L
                                    );
                                }
                                M--;
                                return (
                                    (Q / 2) * (-Math.pow(2, -10 * M) + 2) + L
                                );
                                break;
                            case 'easeInOut':
                            case 'mcsEaseInOut':
