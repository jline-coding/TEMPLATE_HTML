...
## 自動返信メールの差出人名
$config{'fromname'} = '【 MARUTTO LPから資料請求の申し込みです】';
...
## 設置者に届くメールの件名
$config{'subject'} = '【 MARUTTO LPから資料請求の申し込みです】';

## 設置者に届くメールの本文整形
$_TEXT{'posted'} = <<'__posted_body__';
MARUTTO LPから資料請求の申し込みです。
──────────────────────────
...
$config{"ReturnSubject"} = '【MARUTTOの資料請求のお申し込み完了】';
...
この度は資料をご請求いただき、誠にありがとうございました。
下記よりダウンロードいただけますでしょうか。

■MARUTTOの資料はこちら
　https://marutto-coding.com/file/marutto.pdf
...
この度お問い合わせいただき重ねてお礼申し上げます

──────────────────────────
MARUTTO コーディング代行
https://marutto-coding.com/

ジェイ・ライン株式会社 
Webマーケティング事業部
Tel：06-6110-8717（ 月~金 10:00~19:00 ）
〒550-0015 大阪市西区南堀江1-11-1 三共四ツ橋ビル11F 
