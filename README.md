...
1. **Config**:
   - `deploy-config.json`: Set `"MODE": "new"`, `"OUTPUT_EXT": "html"`, `"USE_PHP_INCLUDE": "false"`, `"SITE_URL": "https://your-domain.com"`.
...
1. **Config**:
   - `deploy-config.json`: Set `"MODE": "new"`, `"OUTPUT_EXT": "php"`, `"USE_PHP_INCLUDE": "false"`, `"SITE_URL": "https://your-domain.com"`.
...
1. **Config**:
   - `deploy-config.json`: Set `"MODE": "new"`, `"OUTPUT_EXT": "php"`, `"USE_PHP_INCLUDE": "true"`, `"SITE_URL": "https://your-domain.com"`.
   - `.env`: **Mandatory.** Set your `WEB_ROOT` and `PROXY_URL` for the PHP proxy to work.
